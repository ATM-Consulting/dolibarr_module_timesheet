...
class modTimesheet extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->numero = 104240; // 104000 to 104999 for ATM CONSULTING
        ...
        $this->picto = 'timesheet@timesheet'; // mypicto@mymodule
        ...
        $this->boxes[$r][1] = "timesheet_box@timesheet";
        $r ++;
        /*
    ...
    {
        return $this->_load_tables('/timesheet/sql/');
    }
}
